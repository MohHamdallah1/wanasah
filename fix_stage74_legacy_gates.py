...
OLD_POLICY_FIXTURE = "            # Variant requires 10 days shelf life minimum\n            var = await make_variant(su, co, prd, min_shelf_life=10)\n\n            # Batch 1: Expired\n"
NEW_POLICY_FIXTURE = "            # Shelf-life is a location/product inventory policy, not ProductVariant master data.\n            var = await make_variant(su, co, prd)\n            await make_stock_policy(\n                su,\n                company_id=co,\n                location_id=loc,\n                variant_id=var,\n                min_shelf_life=10,\n            )\n\n            # Batch 1: Expired\n"
...
def main() -> None:
    ...
    print("STAGE74_LEGACY_GATES_FIXED_OK")
    print("Changed gates:")
    for path in FILES.values():
