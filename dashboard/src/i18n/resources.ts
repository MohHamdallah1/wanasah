  ...
  ar: {
    translation: {
      ...
      inventoryLive: {
        ...
        filterOnHand: "له رصيد فعلي",
        filterOnHandHint: "يوجد رصيد فعلي داخل المستودع.",
  ...
  en: {
    translation: {
      ...
      inventoryLive: {
        ...
        filterOnHand: "Has physical stock",
        filterOnHandHint: "Physical stock exists inside the warehouse.",
