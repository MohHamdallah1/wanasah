...
COMPONENT_TESTS = [
    ...
    (
        "test_warehouse_location_management_postgres_e2e.py",
        "WAREHOUSE_LOCATION_MANAGEMENT_POSTGRES_E2E_STRICT_OK",
    ),
]
...
def static_audit() -> None:
    ...
    if len(routes) != 27:
        fail(f"Warehouse route count drifted: {len(routes)} != 27")
    ...
    print("ROUTES=27_ALL_ADMIN_GUARDED")
...
def main() -> None:
    ...
    print("WAREHOUSE_LOCATION_MANAGEMENT=VERIFIED")
    print("MULTI_WAREHOUSE_BACKEND=VERIFIED")
