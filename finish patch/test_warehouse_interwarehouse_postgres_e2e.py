...
async def ensure_schema_ready() -> str:
    ...
    async with AsyncSessionLocal() as db:
        ...
        required_constraints = {
            "ck_inventory_transfer_headers_chk_transfer_header_session_scope",
            "ck_inventory_transfer_headers_chk_transfer_header_received_by_scope",
            "ck_inventory_transfer_headers_chk_transfer_header_separation_of_duties",
            "ck_inventory_transfer_headers_chk_transfer_header_transit_location_required",
        }
        ...
        if missing:
            raise AssertionError(
                f"TRANSFER_DB_CONSTRAINTS_MISSING={sorted(missing)}"
            )
